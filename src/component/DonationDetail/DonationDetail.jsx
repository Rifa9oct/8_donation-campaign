    ...
    return (
        <div className="p-5 lg:p-0">
            ...
            <div className="bg-[#0b0b0b80] w-[386px] md:w-[728px] lg:w-[1320px] h-[80px] md:h-[130px] lg:left-[266px] top-[410px] md:top-[574px] lg:top-[778px] rounded-b-lg mx-auto absolute roundedleft-80">
                <Link to="/donation"><button style={btnbg} className="text-white py-2 px-2 md:py-4 md:px-[24px] ml-5 md:ml-[37px] mt-5 md:mt-[37px] rounded font-semibold md:text-xl">Donate {price}</button></Link>
            </div>
